  ...
  return (
    <div className="max-w-7xl mx-auto p-6 text-gray-800">
      <header className="text-center mb-8">
        ...
        <p className="mt-2">Effective date: 28/10/2024</p>
      </header>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside">
          <li>
            <strong>Personal Information:</strong> Information that you provide to us directly, such as your name, email address, and phone number when you register on our Site or contact us.
          </li>
          <li>
            <strong>Usage Data:</strong> Information about how you use our Site, including your IP address, browser type, pages visited, and time spent on those pages.
          </li>
          <li>
            <strong>Cookies:</strong> We use cookies and similar tracking technologies to monitor activity on our Site and store certain information.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>To communicate with you, including sending newsletters and marketing communications (with your consent)</li>
        </ul>
      </section>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>To prevent or investigate possible wrongdoing in connection with our Site</li>
          <li>To protect the personal safety of users of our Site or the public</li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>Request correction of your personal information if it is inaccurate</li>
      ...
      <section className="mb-6">
        ...
        <p>Email: <a href="mailto:support@khamgaon.online">support@khamgaon.online</a></p>
      </section>
    </div>
  );
};
